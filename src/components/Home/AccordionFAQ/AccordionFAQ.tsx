...
export function AccordionFAQ() {
  return (
       <div className="mt-10">
        <h3 className="text-center text-5xl font-bold my-10">FAQ</h3>
        <div className="lg:w-3/6 w-full mx-auto">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify ">The History and Evolution of Cricket?</AccordionTrigger>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify">The Global Phenomenon of Football?</AccordionTrigger>
            <AccordionContent className="border-l-4 border-rose-500 p-4 mb-4 text-base">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify">The Speed and Skill of Badminton?</AccordionTrigger>
            <AccordionContent className="border-l-4 border-rose-500 p-4 mb-4 text-base">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify">The Grand Slam Glory of Tennis?</AccordionTrigger>
            <AccordionContent className="border-l-4 border-rose-500 p-4 mb-4 text-base">
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify">The Rise and Impact of Basketball?</AccordionTrigger>
            <AccordionContent className="border-l-4 border-rose-500 p-4 mb-4 text-base">
          ...
          <AccordionItem value="item-6">
            <AccordionTrigger className="lg:text-2xl text-1xl text-xl text-justify">The Team Dynamics of Volleyball?</AccordionTrigger>
            <AccordionContent className="border-l-4 border-rose-500 p-4 mb-4 text-base">
